...
module namespace model="http://www.tei-c.org/pm/models/songs/epub";
    ...
    $input !         (
            ...
            return
                    ...
                    case element(l) return
                        if (@rend='indent') then
                            epub:block($config, ., ("tei-l1", css:map-rend-to-class(.)), .)
                        else
                            epub:block($config, ., ("tei-l2", css:map-rend-to-class(.)), .)
                    ...
                    case element(lg) return
                        if (@type='stanza') then
                            epub:block($config, ., ("tei-lg1", css:map-rend-to-class(.)), .)
                        else
                            epub:block($config, ., ("tei-lg2", css:map-rend-to-class(.)), .)
                    ...
                    case element(body) return
                        epub:block($config, ., ("tei-body", css:map-rend-to-class(.)), .)
                    ...
                    case element(text) return
                        epub:block($config, ., ("tei-text", css:map-rend-to-class(.)), .)
