...
module namespace model="http://www.tei-c.org/pm/models/songs/fo";
    ...
    $input !         (
            ...
            return
                    ...
                    case element(l) return
                        if (@rend='indent') then
                            fo:block($config, ., ("tei-l1", css:map-rend-to-class(.)), .)
                        else
                            fo:block($config, ., ("tei-l2", css:map-rend-to-class(.)), .)
                    ...
                    case element(pb) return
                        ...
                        return
                                                fo:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-pb", css:map-rend-to-class(.)), $content)
                    ...
                    case element(lg) return
                        if (@type='stanza') then
                            fo:block($config, ., ("tei-lg1", css:map-rend-to-class(.)), .)
                        else
                            fo:block($config, ., ("tei-lg2", css:map-rend-to-class(.)), .)
                    ...
                    case element(head) return
                        if (parent::div1) then
                            fo:heading($config, ., ("tei-head1", css:map-rend-to-class(.)), ., 2)
                        else
                            if (parent::div2) then
                                fo:heading($config, ., ("tei-head2", css:map-rend-to-class(.)), ., 3)
                            else
                                fo:heading($config, ., ("tei-head3", css:map-rend-to-class(.)), ., ())
                    ...
                    case element(body) return
                        fo:block($config, ., ("tei-body", css:map-rend-to-class(.)), .)
                    ...
                    case element(text) return
                        fo:block($config, ., ("tei-text", css:map-rend-to-class(.)), .)
                    ...
                    case element(div1) return
                        if (@type='book') then
                            (
                                fo:section($config, ., ("tei-div11", css:map-rend-to-class(.)), .)
                            )

                        else
                            fo:section($config, ., ("tei-div12", css:map-rend-to-class(.)), .)
                    case element(div2) return
                        if (@type='poem') then
                            (
                                fo:section($config, ., ("tei-div21", css:map-rend-to-class(.)), .)
                            )

                        else
                            fo:section($config, ., ("tei-div22", css:map-rend-to-class(.)), .)
                    case element() return
                    ...
                    case text() | xs:anyAtomicType return
                        fo:text($config, ., ("tei--text", css:map-rend-to-class(.)), .)
                    default return 
                        $config?apply($config, ./node())
